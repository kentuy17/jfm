<div class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
									<div class="kt-header__topbar-user">
										<span class="kt-header__topbar-welcome kt-hidden-mobile">Hi,</span> <span class="kt-header__topbar-username kt-hidden-mobile"><?=$this->session->userdata('name');?></span> 
										<img class="" alt="Pic" src="<?=base_url();?>assets/media/users/300_25.jpg" />
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									...
									<div class="kt-notification">
										...
										<div class="kt-notification__custom kt-space-between"> <a href="<?=site_url('login/logout');?>" class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a> </div>
									</div>
									<!--end: Navigation -->
