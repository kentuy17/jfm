...
<base href="<?=base_url()?>"><!--end::Base Path -->
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700|Asap+Condensed:500">        <!--end::Fonts -->
                    ...
                    <!--begin::Page Custom Styles(used by this page) -->
                             <link href="./assets/css/demo100/pages/login/login-4.css" rel="stylesheet" type="text/css" />
...
<!--begin::Global Theme Styles(used by all pages) -->
                    ...
                    <link href="./assets/css/demo100/style.bundle.css" rel="stylesheet" type="text/css" />
...
<!--begin::Global Theme Bundle(used by all pages) -->
		    	   ...
		    	   <script src="./assets/js/demo100/scripts.bundle.js" type="text/javascript"></script>
				<!--end::Global Theme Bundle -->

        
                    <!--begin::Page Scripts(used by this page) -->
                            <script src="./assets/js/demo100/pages/login/login-general.js" type="text/javascript"></script>
                        <!--end::Page Scripts -->
            </body>
    <!-- end::Body -->
</html>
