	...
	<form method="POST" action="">
		<div class="kt-portlet__head kt-portlet__head--lg">
			<div class="kt-portlet__head-label">
				<h3 class="kt-portlet__head-title">Edit Location <small>some text here...</small></h3>
			</div>
			<div class="kt-portlet__head-toolbar">
				<a href="<?php echo site_url('admin/location');?>" class="btn btn-clean kt-margin-r-10">
					...
					<div class="col-xl-6">
						<div class="kt-section kt-section--first">
							<div class="kt-section__body">
								<h3 class="kt-section__title kt-section__title-lg">Location Info:</h3>
								<div class="form-group row">
									<label class="col-3 col-form-label">ID</label>
									<div class="col-9">
										<input class="form-control" type="text" name="id" value="<?php echo $location->id;?>" readonly>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-3 col-form-label">Location</label>
									<div class="col-9">
										<input class="form-control" type="text" name="location" value="<?php echo $location->location;?>">
									</div>
								</div>
							</div>
						</div>
