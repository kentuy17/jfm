									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												...
												&nbsp;
												<a href="<?php echo base_url('admin/location?add') ?>">
								...
								<div class="kt-portlet__body" style="overflow-x: auto">
										...
										<tbody>
											...
											<tr>
												...
												<td nowrap>
													<a href="<?php echo base_url('admin/location?edit&id='.$row->id);?>">
														<i class="fa fa-pen-alt"> </i>
													</a> &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;
													<!--a href="#" data-href="delete.php?id=23" data-toggle="modal" data-target="#confirm-delete">Delete record #23</a-->
													<a href="<?php echo base_url('admin/location?delete&id='.$row->id);?>" data-href="" data-toggle="modal" data-target="#confirm-delete">
