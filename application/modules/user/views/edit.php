									...
									<form method="POST" action="">
										<div class="kt-portlet__head kt-portlet__head--lg">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Edit User <small>some text here...</small></h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<a href="<?php echo site_url('user/userlist');?>" class="btn btn-clean kt-margin-r-10">
													<i class="la la-arrow-left"></i>
													<span class="kt-hidden-mobile">Back</span>
												</a>
												<div class="btn-group">
													<a href="?action=continue">
														<input type="submit" name="save" class="btn btn-brand" value="Save"/>
													</a>
															...
															<div class="kt-section__body">
																...
																<div class="form-group row">
																	...
																	<div class="col-3">
																		...
																		<span class="form-text text-muted">Lastname</span>
																	</div>
																	<div class="col-3">
																	...
																	<div class="col-3">
																		<input class="form-control" type="text" name="middle_name" value="<?php echo $user->middle_name;?>">
																		<span class="form-text text-muted">Middlename</span>
																	</div>
																</div>
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<select name="department" class="form-control">
																			<?php foreach($department as $row){?>
																				<option value="<?php echo $row->department;?>" <?php echo ($user->Department==$row->department ? "SELECTED" : "");?>><?php echo $row->department;?></option>
																			<?php } ?>
																		</select>
																	...
																	<div class="col-9">
																		<select name="rank" class="form-control">
																			<?php foreach($rank as $row){?>
																				<option value="<?php echo $row->rank;?>"<?php echo ($user->rank==$row->rank ? "SELECTED" : "");?>><?php echo $row->rank;?></option>
																			<?php } ?>
																		</select>
																	...
																	<div class="col-9">
																		<select name="location" class="form-control">
																			<?php foreach($location as $row){?>
																				<option value="<?php echo $row->location;?>"<?php echo ($user->location==$row->location ? "SELECTED" : "");?>><?php echo $row->location;?></option>
																			<?php } ?>
																		</select>
																	</div>
																</div>
